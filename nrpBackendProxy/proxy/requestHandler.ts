...
let TemplateExperimentsService = require('./TemplateExperimentsService')
  ...
  KubernetesDiscoveryService = require('./KubernetesDiscoveryService').default;
...
function initialize(config) {
  KubernetesDiscoveryService.query(config)
    .then((newConfig) =>  reloadConfiguration(newConfig))
